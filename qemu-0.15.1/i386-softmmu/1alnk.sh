...
-iprefix=/home/nathan/android-ndk-r7/platforms/android-5/arch-arm/     \
-mandroid --embedded-relocs --no-undefined \
...
kvm-stub.o xen-stub.o ../cutils.o ../cache-utils.o \
../qemu-malloc.o ../qemu-option.o ../module.o ../async.o ../nbd.o ../block.o \
../aio.o ../aes.o ../qemu-config.o ../qemu-progress.o ../qemu-sockets.o \
../posix-aio-compat.o ../block/raw.o ../block/cow.o ../block/qcow.o \
...
../net/dump.o ../net/tap.o ../net/tap-linux.o ../qint.o ../qstring.o ../qdict.o \
../qlist.o ../qfloat.o ../qbool.o ../qjson.o ../json-lexer.o ../json-streamer.o \
../json-parser.o ../qerror.o ../error.o ../readline.o ../console.o ../cursor.o \
../qemu-error.o ../osdep.o ../oslib-posix.o ../qemu-thread-posix.o ../os-posix.o \
../tcg-runtime.o ../host-utils.o ../irq.o ../ioport.o ../input.o ../i2c.o \
../smbus.o ../smbus_eeprom.o ../eeprom93xx.o ../scsi-disk.o ../cdrom.o \
../scsi-generic.o ../scsi-bus.o ../usb.o ../usb-hub.o ../usb-linux.o ../usb-hid.o \
../usb-msd.o ../usb-wacom.o ../usb-serial.o ../usb-net.o ../usb-bus.o ../usb-desc.o \
...
../migration-exec.o ../migration-unix.o ../migration-fd.o ../audio/audio.o \
...
../iov.o ../acl.o ../compatfd.o ../notify.o ../event_notifier.o \
...
../libhw64/hda-audio.o ../trace.o vga.o mc146818rtc.o i8259.o pc.o \
cirrus_vga.o sga.o apic.o ioapic.o piix_pci.o vmport.o device-hotplug.o pci-hotplug.o \
smbios.o wdt_ib700.o debugcon.o multiboot.o pc_piix.o  \
\
-I/home/nathan/android/SDL-1.2.15/Inst/include 	\
-lz -llog -lc -lm \
-L/home/nathan/android/SDL-1.2.15/Inst/lib -l:libSDL.a  -l:libSDLmain.a \

#-L/home/nathan/android/SDL-1.2.15/Inst/lib \
#-Wl,-rpath,/home/nathan/android/SDL-1.2.15/Inst/lib -lSDL   -lm -lz  
